...
print(f"  cross-tool merges: {agg['cross_tool_merged_findings']}")  # FINDINGS with n_tools>1 — the population audited below
print(f"  final findings   : {agg['deduplicated_count']}")
rate = 100.0 * agg["cross_tool_merged_findings"] / max(1, agg["same_tool_deduplicated_count"])
